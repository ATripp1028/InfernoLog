...
authedRoute('PUT /v1/me/collections/{collectionId}/ordering')
authedRoute('GET /v1/me/collections/{collectionId}/levels')
authedRoute('POST /v1/me/collections/{collectionId}/entries')
authedRoute('POST /v1/me/collections/{collectionId}/entries/copy')
...
authedRoute('PATCH /v1/me/log-presets/{id}')
authedRoute('DELETE /v1/me/log-presets/{id}')
