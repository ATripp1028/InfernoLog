...
-- CreateEnum
CREATE TYPE "ActivityEventType" AS ENUM ('RANKING_PLACEMENT', 'RANKING_REORDER', 'RANKING_UNRANKED', 'RANKING_BULK_REPLACE', 'RANKING_REBALANCE', 'LOG_EDIT', 'RATING_CONFIG_CHANGE');
