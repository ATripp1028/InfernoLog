    ...
    <header className="flex h-16 shrink-0 items-center gap-4 border-b border-border-subtle bg-bg-surface px-4 xl:px-6">
      ...
      <div className="flex flex-1 justify-end md:justify-start">
        ...
        <Link
          ...
          className="hidden h-10 w-full max-w-md items-center gap-2 rounded-btn border border-[#333333] bg-[#212121] px-3 text-sm text-text-tertiary transition-colors hover:border-[#444444] md:flex"
        >
          <Search size={16} />
          Search levels…
        </Link>
