// How wide the Log table needs to be. The page reads this to decide whether
...
//
// Extracted from LogTable so useLogPage does not import from a component
// file to get at it.
 ...
 *
 * Shared by LogTable (which renders them) and {@link tableMinWidth} (which
