...
import type { LogItem, SortKey, SortSpec } from './types'
...
interface ListTableProps {
  ...
  onDeleteItem: (item: LogItem) => void
  onNavigate: (item: LogItem) => void
  onAddToCollectionItem: (item: LogItem) => void
  onLogItem: (item: LogItem, path: FlowPath) => void
}
