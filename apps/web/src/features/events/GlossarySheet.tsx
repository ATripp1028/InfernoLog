...
const GLOSSARY: GlossarySection[] = [
  ...
  },
  {
    ...
    entries: [
      {
        term: 'Placed',
        meaning: 'The level entered your demon list for the first time.',
        icon: ListOrdered,
        tone: 'ranking',
      },
      {
      ...
      {
        term: 'Removed',
        meaning: 'It left your demon list. Its history stays here.',
        icon: Undo2,
        tone: 'ranking',
      },
      {
        term: 'An import replaced your demon list',
        meaning:
  ...
  },
  {
    ...
    entries: [
      ...
      {
        term: '“Up 43 in your ranking”',
        meaning:
          "When a rating changes, the entry also shows the level's new average and where it moved in your ranking.",
        icon: Sparkles,
        tone: 'edit',
      },
    ],
