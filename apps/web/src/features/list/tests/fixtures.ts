// Builders for the List page's own shapes. Feature-local, same reasoning as
...
import type { FilterState, ListItem } from '../types'
...
export function level(
  overrides: Loose<ListItem['level']> = {}
): ListItem['level'] {
...
export function entry(
  overrides: Loose<NonNullable<ListItem['entry']>> = {}
): NonNullable<ListItem['entry']> {
  return {
 ...
 */
export function item(overrides: Loose<ListItem> = {}): ListItem {
  return {
