...
const FIELD_DESCRIPTIONS = [
  ...
  ['Completions', 'level_id', 'no*', 'Numeric in-game level ID. Leave blank to resolve by level_name + creator.'],
  ['Completions', 'level_name', 'no*', 'Level name. Required when level_id is blank (used to resolve the ID).'],
  ['Completions', 'creator', 'no', 'Creator name — disambiguates when level_name matches multiple levels.'],
  ['Completions', 'date', 'no', 'In your selected date format (MM/DD/YYYY by default)'],
  ['Completions', 'date_uncertain', 'no', 'TRUE or FALSE'],
  ['Completions', 'attempts', 'no', 'Integer — cumulative attempt count'],
  ['Completions', 'percentage', 'no', 'Worst fail / last logged % (0-100)'],
  ['Completions', 'run_from', 'no', 'Start of best run segment (0-100)'],
  ['Completions', 'run_to', 'no', 'End of best run segment (0-100)'],
  ...
  ['', '', '', ''],
  ['Dropped', 'level_id', 'no*', 'Numeric in-game level ID. Leave blank to resolve by level_name + creator.'],
  ['Dropped', 'level_name', 'no*', 'Level name. Required when level_id is blank.'],
  ['Dropped', 'creator', 'no', 'Creator name — disambiguates when level_name matches multiple levels.'],
  ['Dropped', 'best_progress', 'no', 'Best percentage reached (0-100)'],
  ['Dropped', 'run_from', 'no', 'Start of best run segment (0-100)'],
  ['Dropped', 'run_to', 'no', 'End of best run segment (0-100)'],
  ['Dropped', 'attempts_at_drop', 'no', 'Integer attempt count at time of drop'],
  ['Dropped', 'dropped_at', 'no', 'Date in your selected format'],
  ['Dropped', 'reason', 'no', 'Free text (max 2000 chars)'],
  ['Dropped', 'gddl_tier_at_drop', 'no', 'Numeric tier at time of drop'],
  ['', '', '', ''],
