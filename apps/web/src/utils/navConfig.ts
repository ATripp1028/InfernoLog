...
export const NAV_ITEMS: NavItem[] = [
  { key: 'list', label: 'List', icon: LayoutList, to: '/list', status: 'enabled' },
  { key: 'ranking', label: 'Ranking', icon: Trophy, to: '/ranking', status: 'enabled' },
  { key: 'log', label: 'Log', icon: ScrollText, to: '/log', status: 'enabled' },
