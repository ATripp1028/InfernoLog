...
import { Toolbar } from '@/features/log/Toolbar'
import { LogTable } from '@/features/log/LogTable'
import { MobilePager } from '@/features/log/MobilePager'
import { FilterPanel } from '@/features/log/FilterPanel'
import { ControlsSheet } from '@/features/log/ControlsSheet'
import { PresetSheet } from '@/features/log/PresetSheet'
import { PresetCreateDialog } from '@/features/log/PresetCreateDialog'
import { useLogPage } from '@/features/log/useLogPage'
import { EmptyState } from '@/components/data/EmptyState'

/**
 * The Log — every level the user has logged, with saved views, filters, and sorts.
 */
export function Log() {
  const {
    isLoading,
