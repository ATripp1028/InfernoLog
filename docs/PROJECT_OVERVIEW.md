...
| `RANKING_SYSTEM.md`             | Personal ranking, manual placement, ranking events, reconstruction definitions                                                                                                                                                                             |
| `LIST_INTEGRATIONS.md`          | GDDL tier tracking (multi-list AREDL/NLW design was abandoned)                                                                                                                                                 |
| `EVENT_LOG.md`                  | Event taxonomy: ranking moves, log edits, rating-config changes — what is tracked, what is deliberately not                                                                                                     |
