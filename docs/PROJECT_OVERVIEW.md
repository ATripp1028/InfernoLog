...
| `E2E_TESTING.md`                | Playwright against a real staging backend — designed and deferred, not implemented; the Cognito audience and Amplify storage constraints it depends on                                                         |
