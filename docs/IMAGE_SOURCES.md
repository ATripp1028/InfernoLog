All images in the **/apps/web/public/assets/gd** directory are sourced from the **GJ_GameSheet02-uhd.png** and **GJ_GameSheet03-uhd.png** spritesheets in the resources folder in the game files and extracted using GD Colon's [Geometry Dash Spritesheet Splitter](https://gdcolon.com/gdsplitter/).
